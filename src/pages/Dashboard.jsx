...
import { FileText, AlertCircle, DollarSign, ChevronRight, Shield, TrendingUp, Upload, Search, Filter } from 'lucide-react';
...
export default function Dashboard({ user, onLogout }) {
  ...
  const successRate = bills.length > 0 
    ? Math.round(((bills.filter(b => b.bill_analyses[0]?.potential_savings > 0).length / bills.length) * 100))
    : 0;
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200 rounded-2xl pl-12 pr-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-sm"
                />
              </div>
              <button className="flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-2xl px-6 py-3 text-gray-700 hover:bg-gray-50 transition-colors shadow-sm font-medium">
